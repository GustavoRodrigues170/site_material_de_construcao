    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row caminho-barra">
                <div class="col-12">
                    <p><a href="index.php"> Home </a> / <a href="perfil.php"> Perfil </a> / <a href="itens-cadastrados.php"> Itens Cadastrados </a> / Cadastrar Item </p>
                </div>
            </div> 
        </div>
            ...
            <form>
                <div class="row">
                    <div class="col-12 col-md-6">
                        <label for="nome"><h6> Nome do Item </h6></label>
                        <input type="text" class="form-control" placeholder="Nome" id="nome">
                    </div>

                    <div class="col-12 col-md-6">
                        <label for="categoria"><h6> Categoria do Item </h6></label>
                ...
                <div class="row">
                    <div class="col-12 col-md-6">
                        <label for="imagem"><h6> Imagem do Item </h6></label>
                        <input type="file" class="form-control"  id="imagem">
                    </div>

                    <div class="col-12 col-md-6">
                        <label for="preco"><h6> Preço do Item </h6></label>
                ...
                <div class="row">
                    <div class="col">
                        <label for="descricao"><h6> Descrição do Item </h6></label> <br>
                        <textarea class="descricao" name="textarea" rows="5" cols="41"> </textarea>
                    </div>
                </div>

                <button  type="submit" class="btn"> <a href="itens-cadastrados.html"> Cadastrar </a></button>
