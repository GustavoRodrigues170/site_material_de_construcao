        ...
        <div class="container">
            <div class="row title">
                ...
                <div class="col-6 botao-cadastrar">
                    <button class="btn"> <a href="categorias_adicionar.php"> Cadastrar categoria </a></button>
                </div>
            </div>

            <div class="row caminho-barra">
                <div class="col-12">
                    <p><a href="index.php"> Home </a> | <a href="perfil.php"> Perfil </a> |<a href="produtos.php"> Produtos </a> | Categorias </p>
                </div>
            </div> 
                ...
                <?php
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        echo "<div class='row row-itens-cadastrados'>
                                <div class='col-3'> <h5 class='nome-categoria'>".$row['nomeCategoria']."</h5></div>
                                ...
                                <div class='col-3 icon-editar'>
                                    <a href='editar_categoria.php?idCategoria=".$row['idCategoria']."'><img src='img/editar.png' alt='Editar'></a>
                                    <a href='bd_remover_categoria.php?idCategoria=".$row['idCategoria']."'><img src='img/excluir.png' alt='Excluir'></a>
                                </div>
                            </div>";
                        }
                    } else {
                        echo "<p class='nome-categoria'> Nenhuma categoria cadastrada <p>";
                    }
