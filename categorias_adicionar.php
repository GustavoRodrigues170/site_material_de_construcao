    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row caminho-barra">
                <div class="col-12">
                    <p><a href="index.php"> Home </a> | <a href="perfil.php"> Perfil </a> | <a href="produtos.php"> Produtos </a> | <a href="categorias.php"> Categorias </a> | Cadastrar Categoria</p>
                </div>
            </div> 
        </div>

        <div class="container form">
            <form method="post" action="bd_registro_categoria.php">
                <div class="row">
                    <div class="col-6">
