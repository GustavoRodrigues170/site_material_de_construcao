    ...
    <header>
        ...
        <div class="container">
            ...
            <div class="row caminho-barra">
                <div class="col-12">
                    <p><a href="index.php"> Home </a> / <a href="lista-itens.php"> Produtos </a> / Tintas </p>
                </div>
            </div> 
        </div>
        <?php
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        while($row = mysqli_fetch_assoc($result)){
                          echo  " <div class='container'>
                            <div class='row'>
                                <div class='col-12 col-md-4 descricao-produto'>
                                    <h3> ".$row['nomeProduto']." </h3>
                                    <h5> Descrição </h5>
                                    <p> ".$row['descricaoProduto']."</p>
                                </div>
                
                                <div class='col-12 col-md-4 imagem'>
                                    <img src='imagens/".$row['imagem']."' alt='Imagem da Tinta' class='img-fluid'>
                                </div>
                
                                <div class='col-12 col-md-4 coluna-direito'>
                                    <h5>  ".$row['precoProduto']."   </h5>
                                    <div class='frete'>
                                        <label> Calcule seu frete </label> <br>
                                        <input  type='text' placeholder='Insira seu CEP'> <br>
                                    </div>
                                    <button class='btn'> Comprar <i class='bi bi-cart'></i></button>
                                </div>
                            </div>
                        </div>";
                        }
