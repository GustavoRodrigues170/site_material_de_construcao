...
$conexao = conectar();
$sql = "SELECT * FROM table_fornecedores WHERE idFornecedor = $id";
    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row caminho-barra">
                <div class="col-12">
                <p><a href="index.php"> Home </a> | <a href="perfil.php"> Perfil </a> | <a href="produtos.php"> Produtos </a> | <a href="fornecedores.php"> Fornecedores </a> | Editar Fornecedor </p>
                </div>
            </div> 
        </div>

        <div class="container form">
            <form method="post" action="bd_editar_fornecedor.php">
                <div class="row">
                    <div class="col-6">
                        <label for="nome"><h6> Nome do Fornecedor: </h6></label>
