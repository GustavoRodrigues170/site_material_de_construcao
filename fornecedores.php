        ...
        <div class="container">
            <div class="row title">
                ...
                <div class="col-6 botao-cadastrar">
                    <button class="btn"> <a href="fornecedores_adicionar.php"> Cadastrar fornecedor </a></button>
                </div>
            </div>

            <div class="row caminho-barra">
                <div class="col-12">
                    <p><a href="index.php"> Home </a> | <a href="perfil.php"> Perfil </a> | <a href="produtos.php"> Produtos </a> | Fornecedores </p>
                </div>
            </div> 
                ...
                <?php
                    ...
                    if (mysqli_num_rows($result) > 0) {
                        ...
                        echo "<div class='row row-itens-cadastrados'>
                                <div class='col-3'> <h5 class='nome-categoria'>".$row['nomeFornecedor']."</h5></div>
                                ...
                                <a href='editar_fornecedor.php?idFornecedor=".$row['idFornecedor']."'><img src='img/editar.png' alt='Editar'></a>
                                <a href='bd_remover_fornecedor.php?idFornecedor=".$row['idFornecedor']."'><img src='img/excluir.png' alt='Excluir'></a>
                                </div>
                            </div>";
                        }
                    } else {
                        echo "<p class='nome-categoria'> Nenhum fornecedor cadastrado <p>";
                    }
