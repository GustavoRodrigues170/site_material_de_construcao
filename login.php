    ...
    <body>
        ...
        <div class="container form">
            <form method="post" action="autenticacao.php">
                ...
                <p><input class="btn btn-primary button-geral" type="submit" value="Autenticar"></p>
            </form>
            <p class="cadastro-link"> Não é usuario ainda? <a href="cadastro-usuario.php"> Cadastre-se aqui</a> </p>
