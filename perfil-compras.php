    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row caminho-barra">
                <div class="col-12">
                    <p><a href="index.php"> Home </a> | <a href="perfil.php"> Perfil </a> | Compras </p>
                </div>
            </div> 
        ...
        <!-- ITENS COMPRADOS -->
            ...
            <div class="row row-itens">
                <div class="col-3">
                    <img src="img/p5.jpg" alt="Produto Comprado 1">
                    <p> Aparador de Grama 1500W 127V Trapp <br><b> Ferramentas </b></p>
                </div>

                <div class="col-3">
                    <input type="number" min="1"  id="quantidade-produtos" value="1">
                </div>

                <div class="col-3 preco-margin">
                    <p class="preco-produtos"> R$ 99,00 </p>
                </div>
            ...
            <div class="row row-itens">
                <div class="col-3">
                    <img src="img/p1.jpg" alt="Produto Comprado 2">
                    <p> Tinta Acrílica Fosco Rende e Cobre Branco 20L Suvinil  <br><b> Tintas </b></p>
                </div>
                ...
                <div class="col-3 preco-margin">
                    <p class="preco-produtos"> R$ 190,00 </p>
                </div>
            ...
            <div class="row row-itens">
                <div class="col-3">
                    <img src="img/p7.jpeg" alt="Produto Comprado 3">
                    <p> Lâmpada LED Bulbo Philips 9W Branca E27 - 6500wk <br><b> Iluminação </b></p>
                </div>
                ...
                <div class="col-3 preco-margin">
                    <p class="preco-produtos"> R$ 13,50 </p>
                </div>
