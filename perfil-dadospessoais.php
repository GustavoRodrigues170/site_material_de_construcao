    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row caminho-barra">
                <div class="col-12">
                    <p><a href="index.php"> Home </a> | <a href="perfil.php"> Perfil </a> | Informações Pessoais </p>
                </div>
            </div> 
        </div>
        ...
        $sql = "SELECT * FROM table_usuarios WHERE emailUsuario = '$email'";
        ...
        <div class="container  form">
            <form method="post" action="editar_dadospessoais.php">
            <div class="row">
                    <div class="col">
                        <label for="nome"><h6> Nome Completo * </h6></label>
                        <input type="text" name="nome" class="form-control" <?php echo "value='".$nome."'"; ?> id="nome">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" name="cpf" class="form-control" <?php echo "value='".$cpf."'"; ?> id="cpf">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="email" name="email" class="form-control" <?php echo "value='".$email."'"; ?> id="email">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="password" name="senha" class="form-control" <?php echo "value='".$senha."'"; ?> id="senha">
                    </div>
                </div>
                ...
                <div class="row">
                    <div class="col">
                        ...
                        <input type="text" name="endereco" class="form-control" <?php echo "value='".$endereco."'"; ?> id="cep">
                    </div>

                    <div class="col">
                        <label for="tel"><h6> Telefone </h6></label>
                        <input type="text" name="telefone" class="form-control" <?php echo "value='".$telefone."'"; ?> id="tel">
                    </div>
                </div>
