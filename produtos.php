    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row caminho-barra">
                <div class="col-12">
                    <p><a href="index.php"> Home </a> | <a href="perfil.php"> Perfil <a> | Produtos </p>
                </div>
            </div>
        </div>
        ...
        echo "<div class='container'>
                <div class='row'>
                    <div class='col-12 col-md-4 perfil'>
                        <h5> Categorias </h5>
                        <p> Visualize e adicione as categorias </p>
                        <button  type='submit' class='btn'><a href='categorias.php'> Acessar </a></button>
                    </div>

                    <div class='col-12 col-md-4 perfil'>
                        <h5> Fornecedores </h5>
                        <p> Visualize e adicione os fornecedores </p>
                        <button  type='submit' class='btn'><a href='fornecedores.php'> Acessar </a></button>
                    </div>

                    <div class='col-12 col-md-4 perfil'>
                        <h5> Estoque </h5>
                        <p> Visualize e adicione os produtos </p>
                        <button  type='submit' class='btn'><a href='mercadorias.php'> Acessar </a></button>
                    </div>
                </div>
            </div>";
        } else {
