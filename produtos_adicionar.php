    ...
    <body>
        ...
        <div class="container">
            ...
            <div class="row caminho-barra">
                <div class="col-12">
                    <p><a href="index.php"> Home </a> | <a href="perfil.php"> Perfil </a> |<a href="produtos.php"> Produtos </a> | <a href="mercadorias.php"> Estoque </a> | Cadastrar Produto </p>
                </div>
            </div> 
        </div>

        <div class="container form">
            <form method="post" action="bd_registro_produto.php" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-6">
                    ...
                    <div class="col-6">
                            ...
                            <input type="text" name="preco" class="form-control" placeholder="Preço" id="preco">
                    </div>
                </div>

                <div class="row">
                    <div class="col-6">
                        <label for="imagem"><h6> Imagem do Produto: </h6></label>
                        <input type="file" name="imagem_produto" class="form-control" id="imagem">
                    </div>

                    <div class="col-6">
                        <label for="descricao"><h6> Descrição do Produto: </h6></label>
                        <textarea rows="3" cols="60" name="descricao" id="descricao"> </textarea> 
                    </div>
                </div>
                ...
                <div class="row">
                        ...
                        if(mysqli_num_rows($result) > 0) {
                            while($row = mysqli_fetch_assoc($result)) {
                                echo "<p class='radio'><label><input type='radio' name='categoria' value='".$row['idCategoria']."'> ".$row['nomeCategoria']."</label></p>";
                        ...
                        if(mysqli_num_rows($result) > 0) {
                            while($row = mysqli_fetch_assoc($result)) {
                                echo "<p class='radio'><label><input type='radio' name='fornecedor' value='".$row['idFornecedor']."'> ".$row['nomeFornecedor']."</label></p>";
                            }
                        } else {
